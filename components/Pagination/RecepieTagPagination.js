...
export default function RecipeTagPagination({
  pages,
  currentPage,
  category = "",
}) {
      ...
      <div className="flex-1 flex justify-between sm:hidden">
        <Link
          href={`${
            currentPage === 1
              ? `/recipes/${category}`
              : `/recipes/${category}/page/${currentPage - 1}`
          }`}
        >
          <a
            className={`${
        ...
        <Link href={`/recipes/${category}/page/${currentPage + 1}`}>
          <a
            className={`${
        ...
        <div>
          ...
          >
            ...
            {currentPage === 0 ? (
              <span
                aria-current="page"
                className="z-10 bg-yellow-50 border-yellow-600 text-gray-700 relative inline-flex items-center px-4 py-2 border-x border-y-2 text-sm font-medium"
              >
                Latest Recipes
              </span>
            ) : (
            ...
            {currentPage + 1 !== pages && currentPage !== pages && (
              <Link href={`/recipes/${category}/page/${pages}`}>
            ...
            <Link href={`/recipes/${category}/page/${currentPage + 1}`}>
              <a
                ...
                } relative inline-flex items-center px-2 py-2 border-l border-2 border-yellow-600 bg-yellow-50 text-sm font-medium text-gray-700 hover:bg-yellow-600 hover:text-white`}
              >
