...
import { loadRecipeTagNumberBreadcrumbsSchema } from "../../../../utils/schemaOrg";
...
export default function Recipes({
  ...
  return (
    <div>
      <Head>
        <title>
          {currentTagTitle} - Page {currentPage} | {title}
        </title>
        <link rel="icon" href={urlFor(logo.asset).width(144).url()} />
        <script
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={loadRecipeTagNumberBreadcrumbsSchema(
            currentTagTitle,
            currentTagSlug,
            currentPage,
            title
