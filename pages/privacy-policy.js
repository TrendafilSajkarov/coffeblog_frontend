...
export default function TermsAndConditions({ footer }) {
  return (
    <div>
      <Head>
        <title>Privacy Policy | Coffeenated Stories</title>
      ...
      <div className="container prose prose-a:text-sky-700 mx-auto pt-8">
        <h1>Privacy Policy of Coffeenated Stories</h1>

        <p>
          CoffeenatedStories.com operates the{" "}
          <Link href="/" passHref>
        ...
        <p>
          ...
          anyone decided to use our Service, the Coffeenated Stories website.
        </p>
        ...
        <p>
          ...
          not hesitate to contact us by email at coffeenatedstories@gmail.com.
        </p>
      </div>
    </div>
  );
